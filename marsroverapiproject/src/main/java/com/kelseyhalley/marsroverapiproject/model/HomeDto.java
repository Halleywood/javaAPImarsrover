package com.kelseyhalley.marsroverapiproject.model;



//an object we are using to bind all form data into one Java object instead of using multiple request parameters in our home controller

//tells Spring this will be used as a table in our database. 
